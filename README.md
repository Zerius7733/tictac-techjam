...
| `SEED_DEVELOPMENT_DATA` | `true` in development/local POC, `false` in production | Idempotently seed development users, Alice Frontend/Bob Backend demo Agents, protected resources, and the Order Dashboard project. Set `false` for an empty local database. |
