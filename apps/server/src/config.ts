...
const envSchema = z.object({
  ...
  ORCHESTRATION_RUN_TIMEOUT_MS: z.coerce.number().int().min(1_000).default(600_000),
  ORCHESTRATION_JOB_TIMEOUT_MS: z.coerce.number().int().min(1_000).default(1_800_000),
...
export function loadConfig(environment: NodeJS.ProcessEnv = process.env) {
  ...
  return {
    ...
    orchestrationRunTimeoutMs: env.ORCHESTRATION_RUN_TIMEOUT_MS,
    orchestrationJobTimeoutMs: env.ORCHESTRATION_JOB_TIMEOUT_MS,
