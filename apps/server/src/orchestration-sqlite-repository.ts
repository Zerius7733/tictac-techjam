...
const waitingRunMigration: SqliteMigration = {
  version: 4,
  name: "004_waiting_agent_runs.sql",
  path: path.join(repositoryRoot, "db/migrations/004_waiting_agent_runs.sql"),
};

const archivedAgentMigration: SqliteMigration = {
  version: 5,
  name: "005_archived_agents.sql",
  path: path.join(repositoryRoot, "db/migrations/005_archived_agents.sql"),
};
